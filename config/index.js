...
module.exports = (app) => {
  ...
  app.use(session({
    ...
    cookie: {
      maxAge: 1000 * 60 * 60 * 24 * 3 // tiempo de expiracion de cookie en milisegundos (ejemplo de 3 dias)
    },
    store: MongoStore.create({
      mongoUrl: MONGO_URI,
      ttl: 60 * 60 * 24 * 3 // tiempo de expiracion de sesion en segundos (ejemplo de 3 dias)
    })
  }))
